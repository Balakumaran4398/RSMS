...
export class InventorycortonboxComponent implements OnInit {
  ...
  setallocation() {
    ...
    if (this.selectedType == '3') {
      ...
      if (!this.isActivated) {
        this.userservice.getLCOportalcortonBoxDetails(this.role, this.username, this.selectOperator || this.operatorid || 0, this.isemi, this.dueamount || 0, 2, this.selectArea || 0, this.selectStreet || 0,
        ...
        this.userservice.getLCOportalcortonBoxDetails(this.role, this.username, this.selectOperator || this.operatorid || 0, this.isemi, this.dueamount || 0, 3, this.selectArea || 0, this.selectStreet || 0,
          this.selectedPackage || 0, this.days || 0, this.selectSubscriber || 0, this.smartcardList, this.selectedRechargetype || 0, this.plantype || this.f_date || 0)
          .subscribe((res: any) => {
            this.swal.success(res?.message);
          }, (err) => {
