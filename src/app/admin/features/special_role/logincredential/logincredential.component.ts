...
@Component({
  selector: 'app-logincredential',
  templateUrl: './logincredential.component.html',
  styleUrls: ['./logincredential.component.scss']
})
export class LogincredentialComponent {
form!: FormGroup;
  isLoggedIn = false; 
      ...
      this.swal.Loading();
        ...
        (res: any) => {
          ...
          Swal.fire({
            ...
            if (role === 'ROLE_SPECIAL') {
              this.router.navigate(['admin/loginsettings']).then(() => {
  ...
  exit() {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.router.navigate(['admin/loginsettings_credential']).then(() => {
        });
      }
    });
  }
